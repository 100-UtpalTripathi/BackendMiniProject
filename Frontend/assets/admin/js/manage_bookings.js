document.addEventListener("DOMContentLoaded", function () {
    ...
    const applyFilters = () => {
      ...
      const filteredBookings = allBookings.filter((booking) => {
        ...
        const startDateMatch = !startDate || new Date(booking.bookingDate) >= new Date(startDate);
        const endDateMatch = !endDate || new Date(booking.bookingDate) <= new Date(endDate);
